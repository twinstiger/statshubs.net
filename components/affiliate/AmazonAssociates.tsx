...
const AMAZON_TAGS = {
  en: 'statshubs-20',      // 英文站
  es: 'statshubs-20',      // 西班牙语
  fr: 'statshubs-20',      // 法语
  de: 'statshubs-20',      // 德语
  ja: 'statshubs-20',      // 日语
  pt: 'statshubs-20',       // 葡萄牙语
}
...
// Amazon 联盟链接组件
export function AmazonLink({ asin, lang = 'en', children, className = '', newTab = true }: AmazonLinkProps) {
  ...
  en: [
    {
      ...
      asin: 'B09V3KXJPB', // FIFA World Cup Official Ball
    ...
    },
    {
      id: 'jersey-brazil',
      asin: 'B08XZH3ZKK',
      name: 'Brazil National Team Jersey 2024/25',
      description: 'Official Brazil replica jersey',
      price: '$89.99',
    ...
    },
    {
      id: 'worldcup-book',
      asin: 'B09V3KXJPB',
      name: 'World Cup 2026: The Complete Guide',
      description: 'Comprehensive guide to the tournament',
      price: '$24.99',
      image: 'https://m.media-amazon.com/images/I/51V8K3KLTTL._AC_.jpg'
    }
  ],
  ja: [
    {
      id: 'worldcup-ball-2026',
      asin: 'B09V3KXJPB',
      name: 'アディダス アル・リフラ （W杯2026公式球）',
      description: 'FIFAワールドカップ2026公式試合球',
      price: '¥22,000',
      image: 'https://m.media-amazon.com/images/I/51H0x6qN0XL._AC_SL1500_.jpg'
    }
  ]
...
export function AffiliateSection({ lang = 'en', title, maxProducts = 3 }: AffiliateSectionProps) {
