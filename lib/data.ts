...
export const teams: Team[] = [
  ...
  { slug: 'mexico', name: 'Mexico', flag: '🇲🇽', group: 'A', manager: 'Javier Aguirre', ranking: 12, squad: [
    { id: '1270635', name: 'J.Rangel', position: 'Goalkeeper', age: 27, number: 1, club: '' },
    { id: '79701', name: 'C.Acevedo', position: 'Goalkeeper', age: 31, number: 12, club: '' },
    { id: '13041', name: 'G.Ochoa', position: 'Goalkeeper', age: 42, number: 13, club: '' },
    { id: '57965', name: 'J.Gallardo', position: 'Defender', age: 33, number: 23, club: '' },
    { id: '1160580', name: 'I.Reyes', position: 'Defender', age: 27, number: 15, club: '' },
    { id: '71184', name: 'C.Montes', position: 'Defender', age: 30, number: 3, club: '' },
    { id: '77262', name: 'J.Sánchez', position: 'Defender', age: 30, number: 2, club: '' },
    { id: '1109602', name: 'J.Vásquez', position: 'Defender', age: 29, number: 5, club: '' },
    { id: '911329', name: 'L.Romo', position: 'Defender', age: 32, number: 7, club: '' },
    { id: '1646289', name: 'M.Chávez', position: 'Defender', age: 23, number: 20, club: '' },
    { id: '1112560', name: 'E.Lira', position: 'Midfielder', age: 27, number: 6, club: '' },
    { id: '1248883', name: 'B.Gutierrez', position: 'Midfielder', age: 24, number: 26, club: '' },
    { id: '84514', name: 'O.Pineda', position: 'Midfielder', age: 31, number: 17, club: '' },
    { id: '83072', name: 'E.Álvarez', position: 'Midfielder', age: 30, number: 4, club: '' },
    { id: '57744', name: 'L.Chavez', position: 'Midfielder', age: 31, number: 24, club: '' },
    { id: '1849315', name: 'G.Mora', position: 'Midfielder', age: 19, number: 19, club: '' },
    { id: '1417231', name: 'O.Vargas', position: 'Midfielder', age: 22, number: 18, club: '' },
    { id: '78982', name: 'Á.Fidalgo', position: 'Midfielder', age: 30, number: 8, club: '' },
    { id: '89374', name: 'R.Alvarado', position: 'Forward', age: 29, number: 25, club: '' },
    { id: '1450209', name: 'A.González', position: 'Forward', age: 24, number: 14, club: '' },
    { id: '61639', name: 'G.Martinez', position: 'Forward', age: 32, number: 22, club: '' },
    { id: '70322', name: 'A.Vega', position: 'Forward', age: 30, number: 10, club: '' },
    { id: '911316', name: 'S.Giménez', position: 'Forward', age: 26, number: 11, club: '' },
    { id: '107461', name: 'C.Huerta', position: 'Forward', age: 27, number: 21, club: '' },
    { id: '80963', name: 'J.Quiñones', position: 'Forward', age: 30, number: 16, club: '' },
    { id: '40599', name: 'R.Jiménez', position: 'Forward', age: 36, number: 9, club: '' },
  ], history: { appearances: 17, bestResult: 'Quarterfinals', titles: 0 } },
